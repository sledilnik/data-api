...
namespace SloCovidServer.Controllers
{
    ...
    {
        readonly ILogger<PatientsController> logger;
        readonly ICommunicator communicator;

        public PatientsController(ILogger<PatientsController> logger, ICommunicator communicator)
        {
            this.logger = logger;
        ...
        public async Task<ActionResult<ImmutableArray<PatientsDay>?>> Get()
        {
            ...
            var result = await communicator.GetPatientsAsync(etag, CancellationToken.None);
