...
namespace SloCovidServer.Controllers
{
    ...
    public class RegionsController : MetricsController<RegionsController>
    {
        ...
        public Task<ActionResult<ImmutableArray<RegionCasesDay>?>> GetRegionCases(DateTime? from, DateTime? to)
        {
            return ProcessRequestAsync(communicator.GetRegionCasesAsync, new DataFilter(from, to));
        }
    }
}
