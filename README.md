...
[vaccinations](https://api.sledilnik.org/api/vaccinations), [vaccination-by-age](https://api.sledilnik.org/api/vaccination-by-age), [vaccination-by-region](https://api.sledilnik.org/api/vaccination-by-region) and [vaccination-by-municipality](https://api.sledilnik.org/api/vaccination-by-municipality).
...
* Adds `vaccination-by_age.csv` to API as `/api/vaccination-by-age` endpoint
* Adds `vaccination-by_region.csv` to API as `/api/vaccination-by-region` endpoint
* Adds `vaccination-by_municipality.csv` to API as `/api/vaccination-by-municipality` endpoint
* Schema version 42
