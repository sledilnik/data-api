...
[monthly_deaths_slovenia](https://api.sledilnik.org/api/monthly-deaths-slovenia), [lab-tests](https://api.sledilnik.org/api/lab-tests) and [daily-deaths-slovenia](https://api.sledilnik.org/api/daily-deaths-slovenia).
